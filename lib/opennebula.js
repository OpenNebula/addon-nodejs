...
OpenNebula.prototype.getImages = function(callback, userFilter, startID, endID) {
  this.modem.call('imagepool.info', [userFilter, startID, endID], function(err, data) {
    if (err) return callback(err);
...
OpenNebula.prototype.getDocuments = function(callback, userFilter, startID, endID) {
  this.modem.call('documentpool.info', [userFilter, startID, endID], function(err, data) {
    if (err) return callback(err);
